      ...
      body: _isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            // Pixel Watch Section
            _buildSectionHeader(theme, 'Pixel Watch', Icons.watch_rounded),
            _buildCard(
              theme,
              child: Column(
                children: [
              ...
              child: Column(
                children: [
                  _buildRadioTile<VoiceInputSource>(
                    ...
                    subtitle: 'Use Even Realities G1 glasses mic (primary)',
                    value: VoiceInputSource.glasses,
                    groupValue: _preferredVoiceSource,
                    onChanged: (value) async {
                      if (value != null) {
                        await _voiceInputService.setPreferredSource(value);
                  ...
                  _buildRadioTile<VoiceInputSource>(
                    ...
                    subtitle: 'Use Pixel Watch mic (requires watch connection)',
            ...
            // Test Section
            _buildSectionHeader(theme, 'Test', Icons.play_arrow_rounded),
            _buildCard(
              theme,
              child: Column(
                children: [
